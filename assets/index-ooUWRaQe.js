 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class F1{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(U1(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function U1(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const eh="@firebase/app",cm="0.10.10";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rl=new Map,dS=new Map,nh=new Map;function hm(t,e){try{t.container.addComponent(e)}catch(n){vn.debug(`Component ${e.name} failed to register with FirebaseApp ${t.name}`,n)}}function Ii(t){const e=t.name;if(nh.has(e))return vn.debug(`There were multiple attempts to register component ${e}.`),!1;nh.set(e,t);for(const n of rl.values())hm(n,t);for(const n of dS.values())hm(n,t);return!0}function md(t,e){const n=t.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),t.container.getProvider(e)}function Bt(t){return t.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Oi=cS;function jy(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const r=Object.assign({name:th,automaticDataCollectionEnabled:!1},e),i=r.name;if(typeof i!="string"||!i)throw Gn.create("bad-app-name",{appName:String(i)});if(n||(n=My()),!n)throw Gn.create("no-options");const s=rl.get(i);if(s){if(nl(n,s.options)&&nl(r,s.config))return s;throw Gn.create("duplicate-app",{appName:i})}const a=new w1(i);for(const u of nh.values())a.addComponent(u);const l=new pS(n,r,a);return rl.set(i,l),l}function By(t=th){const e=rl.get(t);if(!e&&t===th&&My())return jy();if(!e)throw Gn.create("no-app",{appName:t});return e}function qn(t,e,n){var r;let i=(r=hS[t])!==null&&r!==void 0?r:t;n&&(i+=`-${n}`);const s=i.match(/\s|\//),a=e.match(/\s|\//);if(s||a){const l=[`Unable to register library "${i}" with version "${e}":`];s&&l.push(`library name "${i}" contains illegal characters (whitespace or "/")`),s&&a&&l.push("and"),a&&l.push(`version name "${e}" contains illegal characters (whitespace or "/")`),vn.warn(l.join(" "));return}Ii(new Pr(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mS="firebase-heartbeat-database",gS=1,Xs="firebase-heartbeat-store";let Xu=null;function zy(){return Xu||(Xu=L1(mS,gS,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(Xs)}catch(n){console.warn(n)}}}}).catch(t=>{throw Gn.create("idb-open",{originalErrorMessage:t.message})})),Xu}async function vS(t){try{const n=(await zy()).transaction(Xs),r=await n.objectStore(Xs).get($y(t));return await n.done,r}catch(e){if(e instanceof En)vn.warn(e.message);else{const n=Gn.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});vn.warn(n.message)}}}async function dm(t,e){try{const r=(await zy()).transaction(Xs,"readwrite");await r.objectStore(Xs).put(e,$y(t)),await r.done}catch(n){if(n instanceof En)vn.warn(n.message);else{const r=Gn.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});vn.warn(r.message)}}}function $y(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rh(){var t;return typeof self<"u"&&((t=self.location)===null||t===void 0?void 0:t.href)||""}function PS(){return mm()==="http:"||mm()==="https:"}function mm(){var t;return typeof self<"u"&&((t=self.location)===null||t===void 0?void 0:t.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class QR{constructor(e){this.ct=e}}function XR(t){const e=KR({parent:t.parent,structuredQuery:t.structuredQuery});return t.limitType==="LAST"?hh(e,e.limit,"L"):e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wl(t){return new FR(t,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class RC{constructor(e,n,r,i,s){this.localStore=e,this.datastore=n,this.asyncQueue=r,this.remoteSyncer={},this.O_=[],this.N_=new Map,this.L_=new Set,this.B_=[],this.k_=s,this.k_._o(a=>{r.enqueueAndForget(async()=>{Io(this)&&(H("RemoteStore","Restarting streams for network reachability change."),await async function(u){const h=ae(u);h.L_.add(4),await wo(h),h.q_.set("Unknown"),h.L_.delete(4),await Kl(h)}(this))})}),this.q_=new PC(r,i)}}async function Kl(t){if(Io(t))for(const e of t.B_)await e(!0)}async function wo(t){for(const e of t.B_)await e(!1)}function Io(t){return ae(t).L_.size===0}async function a0(t,e,n){if(!Bl(e))throw e;t.L_.add(1),await wo(t),t.q_.set("Offline"),n||(n=()=>gC(t.localStore)),t.asyncQueue.enqueueRetryable(async()=>{H("RemoteStore","Retrying IndexedDB access"),await n(),t.L_.delete(1),await Kl(t)})}function l0(t,e){return e().catch(n=>a0(t,n,e))}async function Gl(t){const e=ae(t),n=Zn(e);let r=e.O_.length>0?e.O_[e.O_.length-1].batchId:-1;for(;CC(e);)try{const i=await vC(e.localStore,r);if(i===null){e.O_.length===0&&n.o_();break}r=i.batchId,kC(e,i)}catch(i){await a0(e,i)}u0(e)&&c0(e)}function CC(t){return Io(t)&&t.O_.length<10}function kC(t,e){t.O_.push(e);const n=Zn(t);n.r_()&&n.V_&&n.m_(e.mutations)}function u0(t){return Io(t)&&!Zn(t).n_()&&t.O_.length>0}function c0(t){Zn(t).start()}async function NC(t){Zn(t).p_()}async function xC(t){const e=Zn(t);for(const n of t.O_)e.m_(n.mutations)}async function OC(t,e,n){const r=t.O_.shift(),i=Dd.from(r,e,n);await l0(t,()=>t.remoteSyncer.applySuccessfulWrite(i)),await Gl(t)}async function DC(t,e){e&&Zn(t).V_&&await async function(r,i){if(function(a){return VR(a)&&a!==F.ABORTED}(i.code)){const s=r.O_.shift();Zn(r).s_(),await l0(r,()=>r.remoteSyncer.rejectFailedWrite(s.batchId,i)),await Gl(r)}}(t,e),u0(t)&&c0(t)}async function Ym(t,e){const n=ae(t);n.asyncQueue.verifyOperationInProgress(),H("RemoteStore","RemoteStore received new credentials");const r=Io(n);n.L_.add(3),await wo(n),r&&n.q_.set("Unknown"),await n.remoteSyncer.handleCredentialChange(e),n.L_.delete(3),await Kl(n)}async function LC(t,e){const n=ae(t);e?(n.L_.delete(2),await Kl(n)):e||(n.L_.add(2),await wo(n),n.q_.set("Unknown"))}function Zn(t){return t.U_||(t.U_=function(n,r,i){const s=ae(n);return s.w_(),new SC(r,s.connection,s.authCredentials,s.appCheckCredentials,s.serializer,i)}(t.datastore,t.asyncQueue,{Eo:()=>Promise.resolve(),Ro:NC.bind(null,t),mo:DC.bind(null,t),f_:xC.bind(null,t),g_:OC.bind(null,t)}),t.B_.push(async e=>{e?(t.U_.s_(),await Gl(t)):(await t.U_.stop(),t.O_.length>0&&(H("RemoteStore",`Stopping write stream with ${t.O_.length} pending writes`),t.O_=[]))})),t.U_}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function hk(t,e,n){let r;return r=t?t.toFirestore(e):e,r}function dk(t,e,n){t=mh(t,dn);const r=mh(t.firestore,m0),i=hk(t.converter,e);return fk(r,[ok(sk(r),"setDoc",t._key,i,t.converter!==null,n).toMutation(t._key,hn.none())])}function fk(t,e){return function(r,i){const s=new _r;return r.asyncQueue.enqueueAndForget(async()=>UC(await qC(r),i,s)),s.promise}(tk(t),e)}(function(e,n=!0){(function(i){Li=i})(Oi),Ii(new Pr("firestore",(r,{instanceIdentifier:i,options:s})=>{const a=r.getProvider("app").getImmediate(),l=new m0(new bP(r.getProvider("auth-internal")),new $P(r.getProvider("app-check-internal")),function(h,f){if(!Object.prototype.hasOwnProperty.apply(h.options,["projectId"]))throw new K(F.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new dl(h.options.projectId,f)}(a,i),a);return s=Object.assign({useFetchStreams:n},s),l._setSettings(s),l},"PUBLIC").setMultipleInstances(!0)),qn(Vm,"4.7.1",e),qn(Vm,"4.7.1","esm2017")})();const pk={apiKey:"AIzaSyDI2Ra6xg7pbvt2RLmHZt0AgWQoXmygfxo",authDomain:"aubeaver-8aa8a.firebaseapp.com",projectId:"aubeaver-8aa8a",storageBucket:"aubeaver-8aa8a.appspot.com",messagingSenderId:"229985108021",appId:"1:229985108021:web:ae7f78866760da7a72b17c"},P0=jy(pk),gh=DP(P0),mk=ek(P0),gk=()=>{const[t,e]=yt.useState(""),[n,r]=yt.useState("");yt.useState(""),yt.useState([]);const i=async s=>{s.preventDefault(),console.log("entrou");try{await EA(gh,t,n),console.log("Login feito com sucesso!")}catch(a){console.log(a)}};return L.jsxs("section",{children:[L.jsx("div",{className:Wu.content1,children:L.jsxs("div",{className:Wu.content,children:[L.jsxs("form",{onSubmit:i,children:[L.jsx("a",{children:L.jsx(ri,{label:"Email",type:"email",id:"email",value:t,setValue:e})}),L.jsx("p",{}),L.jsx("a",{children:L.jsx(ri,{label:"Senha",type:"password",id:"password",value:n,setValue:r})}),L.jsx("p",{}),L.jsx("center",{children:L.jsx("button",{children:"Entrar"})})]}),L.jsx("h4",{children:L.jsx(ds,{to:"/login/criar",children:"Cadastre-se"})})]})}),L.jsxs("div",{className:Wu.containerImg,children:[" ",L.jsx("img",{src:xy,alt:"RostoMascote"})," "]})]})},vk="_content_1be1c_103",yk="_content1_1be1c_119",_k="_containerImg_1be1c_147",Ek="_elemento_1be1c_183",wk="_checkbox_1be1c_247",Ik="_inputCheckbox_1be1c_265",as={content:vk,content1:yk,containerImg:_k,elemento:Ek,checkbox:wk,inputCheckbox:Ik},Tk=()=>{const[t,e]=yt.useState(""),[n,r]=yt.useState(""),[i,s]=yt.useState("");yt.useState("");const[a,l]=yt.useState(""),[u,h]=yt.useState(""),[f,m]=yt.useState(""),v=async C=>{C.preventDefault(),console.log(i,a,n,u);try{await _A(gh,a,u);const P=gh.currentUser;console.log(P),P&&await dk(JC(mk,"Usuários",P.uid),{nome:i,email:P.email,username:n,senha:u,Tipo_de_cadastro:t})}catch(P){console.log(P)}};return L.jsx(L.Fragment,{children:L.jsx("body",{children:L.jsxs("section",{children:[L.jsx("div",{className:as.content1,children:L.jsxs("div",{className:as.content,children:[L.jsx("h2",{children:"Cadastre-se"}),L.jsx("p",{}),L.jsx("p",{}),L.jsxs("form",{onSubmit:v,children:[L.jsx(jT,{label:"Entrar como",options:["Pessoa física","Pessoa jurídica"],value:t,setValue:e}),L.jsx("p",{}),L.jsx(ri,{label:"Nome",type:"nome",id:"nome",value:i,setValue:s}),L.jsx("p",{}),L.jsx(ri,{label:"Email",type:"email",id:"email",value:a,setValue:l}),L.jsx("p",{}),L.jsx(ri,{label:"Username",type:"username",id:"usename",value:n,setValue:r}),L.jsx("p",{}),L.jsx(ri,{label:"Senha",type:"password",id:"password",value:u,setValue:h}),L.jsx("p",{}),L.jsxs("label",{className:as.checkbox,children:[" ",L.jsx("input",{className:as.inputCheckbox,type:"checkbox",value:f,checked:f,onChange:function({target:P}){m(P.checked)}})," Li e aceito os termos. "]}),L.jsx("p",{}),L.jsx("center",{children:L.jsx("button",{type:"submit",children:"Cadastre-se"})})]})]})}),L.jsx("div",{className:as.containerImg,children:L.jsx("img",{src:xy,alt:"RostoMascote"})})]})})})},Sk=()=>L.jsx(L.Fragment,{children:L.jsxs(Ny,{children:[L.jsx(Qs,{path:"/",element:L.jsx(gk,{})}),L.jsx(Qs,{path:"criar",element:L.jsx(Tk,{})})]})}),Ak=()=>L.jsx(L.Fragment,{children:L.jsxs(RT,{children:[L.jsx(MT,{}),L.jsxs(Ny,{children:[L.jsx(Qs,{path:"/",element:L.jsx(bT,{})}),L.jsx(Qs,{path:"/login/*",element:L.jsx(Sk,{})})]}),L.jsx(UT,{})]})});nc.createRoot(document.getElementById("root")).render(L.jsx(Ak,{}));
